...
from avalanche.benchmarks.datasets import TinyImagenet, MiniImageNetDataset
...
def SplitImageNet100(
    ...
    *,
    ...
    train_set, test_set = _get_imagenet100_dataset(dataset_root)
...
def _get_imagenet100_dataset(dataset_root):
    train_set = MiniImageNetDataset(imagenet_path=dataset_root)
